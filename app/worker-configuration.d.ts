/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b7502e6280110ab6e4879efaf34d4978)
...
interface __BaseEnv_Env {
  ...
  AI: Ai
  AI_API_KEY: string
  PRISM_ENCODE_WORKFLOW: Workflow<
    Parameters<import("./backend/index").PrismEncodeWorkflow["run"]>[0]["payload"]
  >
}
